...
public class JsonConvertController {
    ...
    public String serializeToPostmanJson(@RequestParam String jsonStr) throws IOException {
        ...
        System.out.println(postmanJsonStr);


        FileWriter fw = new FileWriter("/Users/joker1937/Desktop/postman.json");
    ...
    public Swagger DeserializeSwaggerJson(String inputJson) throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream("/Users/joker1937/Desktop/input.json");
        fos.write(inputJson.getBytes());
        fos.close();
        File jsonFile = new File("/Users/joker1937/Desktop/input.json");
